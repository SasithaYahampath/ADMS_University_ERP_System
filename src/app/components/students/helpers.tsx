...
export const avatarColors = ['#3b5bdb', '#818cf8', '#06b6d4', '#10b981', '#f59e0b', '#f43f5e', '#8b5cf6', '#ec4899'];
...
export const gradeColor = (gpa: number) => (gpa >= 3.7 ? '#10b981' : gpa >= 3.0 ? '#3b5bdb' : '#f59e0b');
