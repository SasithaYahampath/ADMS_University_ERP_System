    ...
    <div className="space-y-4">
      ...
      <div className="bg-card rounded-2xl border p-5 shadow-sm text-center" style={{ borderColor: 'var(--border)' }}>
        <p className="text-muted-foreground text-sm">
          Click <strong className="text-foreground">👁 View</strong> on any student in the{' '}
          <strong className="text-foreground">All Students</strong> tab to see their course-by-course attendance.
        </p>
      </div>
    </div>
  );
